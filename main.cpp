...
void text(void)											// to draw the text in menu screen
{
	...
	glColor3f(1.0,1.0,1.0);
	drawstring(210.0,295.0,1.0,"        Help");
	glColor3f(1.0,1.0,1.0);
	drawstring(200.0,240.0,1.0,"            EXIT");
	glFlush();
}
...
void move2()  //MOVEMENT OF FRAME
{	float i,j,temp=0.1/2.5*2.5;
    //move 1
	...
	drawstring(210.0,5.0,1.0,"The details of the SIM are to be fetched ");
	glColor3f(0.0,1.0,0.0);
	drawstring(210.0,5.0,1.0,"Details Of SIM found.Authentic user ");
	//move 8
	for(j=0;j<50;j=j+temp) //movement of data packet from top to down
	 {   glColor3f(1,0,0);
		 glBegin(GL_QUADS);
	...
	glColor3f(1.0f,1.0f,1.0f);
	drawstring(365.0,310.0,1.0,"MSC/VLR 2");
 	glColor3f(1.0,0.0,0.0);
	drawstring(210.0,5.0,1.0,"Details FOUND!! Need to be Authenticated  ");
	//move 11
	for(j=0;j<90;j=j+temp) //movement of data packet from top to down
	 {   glColor3f(01,0,0);
		 glBegin(GL_QUADS);
	 	  glVertex2i(130+300-50,270-j);glVertex2i(135+300-50,270-j);glVertex2i(135+300-50,265-j);glVertex2i(130+300-50,265-j);
    	 glEnd();
    	 glFlush();
    	 glColor3f(0,0,0);
		 glBegin(GL_QUADS);
	...
	for(i=0;i<57;i=i+temp) //movement of data packet sidewise
	 {   glColor3f(1,0,0);
		 glBegin(GL_QUADS);
	  		glVertex2i(250+130+i,132);glVertex2i(250+130+i,127);glVertex2i(250+135+i,127);glVertex2i(250+135+i,132);
    	 glEnd();
    	 glFlush();
    	 glColor3f(0,0,0);   // to remove traces create movement of frame in black
		 glBegin(GL_QUADS);
	...
	//move 13
	for(i=0;i<80;i=i+(temp/2.5)) //movement of data packet sidewise
	 {   glColor3f(01,0,0);
		 glBegin(GL_QUADS);
	 		 glVertex2i(350+45+50-i,80+70);glVertex2i(350+50+45-i,75+70);glVertex2i(350+50+50-i,75+70);glVertex2i(350+50+50-i,80+70);
   		 glEnd();
    	 glFlush();
         glColor3f(0,0,0);   // to remove traces create movement of frame in black
		 glBegin(GL_QUADS);
	...
	//move 14
	for(j=0;j<53;j=j+temp) //movement of data packet from top to down
	 {   glColor3f(1,0,0);
		 glBegin(GL_QUADS);
	  	  glVertex2i(335+20,80+70-j);glVertex2i(335+20,75+70-j);glVertex2i(340+20,75+70-j);glVertex2i(340+20,80+70-j);
    	 glEnd();
   		 glFlush();
		 glColor3f(0,0,0);
		 glBegin(GL_QUADS);
	...
	glColor3f(1.0,0.0,0.0);
	drawstring(210.0,5.0,1.0,"Authenticated!!  ");
	//move -9
    for(i=0;i<18;i=i+temp) //movement of data packet sidewise
	 {   glColor3f(0,1,0);
		 glBegin(GL_QUADS);
...
//move -7
   ...
   for(j=0;j<50;j=j+temp) //movement of data packet from top to down
	...
	drawstring(210.0,5.0,1.0,"Authenticated!!  ");
	glColor3f(1.0,0.0,0.0);
	drawstring(210.0,5.0,1.0,"Registered on Network !! ");
	glColor3f(0,1,0);
	glBegin(GL_QUADS);
...
{	float i,j,temp=0.1/2.5;
	...
	drawstring(210.0,5.0,1.0,"Details FOUND!! Need to be Authenticated  ");
	//move 11
	for(i=0;i<17;i=i+(temp)) //movement of data packet sidewise
	 {   glColor3f(1,0,0);
		 glBegin(GL_QUADS);
		  glVertex2i(410+i,335-10);glVertex2i(410+i,340-10);glVertex2i(412+i,340-10);glVertex2i(412+i,335-10);
    	 glEnd();
    	 glFlush();
      	 glColor3f(0,0,0);   // to remove traces create movement of frame in black
	 glBegin(GL_QUADS);
	...
	drawstring(210.0,5.0,1.0,"Authenticated!!  ");
	//move -11
	for(i=0;i<17;i=i+(temp/10)) //movement of data packet sidewise
	 {   glColor3f(0,01,0);
		 glBegin(GL_QUADS);
		  glVertex2i(430-3-i,335-10);glVertex2i(430-3-i,340-10);glVertex2i(432-3-i,340-10);glVertex2i(432-3-i,335-10);
    	 glEnd();
    	 glFlush();
      	 glColor3f(0,0,0);   // to remove traces create movement of frame in black
	 glBegin(GL_QUADS);
...
{
glColor3f(1.0f,1.0f,1.0f);
drawstring(20.0,455.0,1.0,"HELP- Various Terminologies used in the project are explained below ");
glColor3f(1.0f,0.0f,0.0f);
drawstring(20.0,420.0,1.0,"BTS : Base Transeiver Station ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,405.0,1.0,"A base transceiver station (BTS) is a piece of equipment that facilitates wireless communication between user ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,390.0,1.0,"equipment (UE) and a network. UEs are devices like mobile phones (handsets), WLL phones, computers with wireless internet ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,375.0,1.0,"connectivity, WiFi and WiMAX devices and others. The network can be that of any of the wireless communication technologies ");
glColor3f(1.0f,0.0f,0.0f);
drawstring(20.0,350.0,1.0,"BSC : Base Transeiver Station ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,335.0,1.0,"like GSM, CDMA, Wireless local loop, WAN, WiFi, WiMAX, etc.The base station controller (BSC) provides, classically, the intelligence ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,320.0,1.0,"behind the BTSs. Typically a BSC has of BTSs under its control. The BSC handles allocation of radio channels, receives measurements ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,305.0,1.0,"from the mobile phones, and controls handovers from BTS to BTS. A key function of the BSC is to act as a concentrator where many different low capacity connections to BTSs become reduced to a smaller number of ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,290.0,1.0," different low capacity connections to BTSs become reduced to a smaller number ofconnections towards the mobile switching center (MSC).Overall, this means that networks are often structured to have many BSCs distributed");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,275.0,1.0,"Overall, this means that networks are often structured to have many BSCs distributed into regions near their BTSs which are then connected to large centralised MSC sites.    ");
glColor3f(1.0f,0.0f,0.0f);
drawstring(20.0,250.0,1.0," MSC : Mobile Switching centre      ");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,235.0,1.0,"The mobile switching center (MSC) is the primary service delivery node for GSM/CDMA, responsible for routing voice calls and SMS as well as other services.");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,220.0,1.0,"The MSC sets up and releases the end-to-end connection, handles mobility and hand-over requirements during the call and takes care of real time pre-paid account monitoring.");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,205.0,1.0,"In the GSM mobile phone system,fax and data information is sent directly digitally encoded to the MSC. Only at the MSC is this re-coded into an analog signal");
glColor3f(0.0f,1.0f,0.0f);
drawstring(20.0,190.0,1.0," There are various types of MSCs. To name a few Gateway MSC, Visitor MSC, Anchor MSC is one of the few of the MSCs");
...
{ int j;int temp=5;
	...
	{ case 1: 	glColor3f(1.0f,1.0f,1.0f);
 	...
 	case 2:     glClear(GL_COLOR_BUFFER_BIT);
				...
				glBegin(GL_POLYGON);
				 glColor3f(1,0.0,0.0);
				 glVertex2f(310,335-130);
				 glVertex2f(310,340-130);
				 glVertex2f(330,340-130);
				 glVertex2f(330,335-130);
				glEnd();
				//link mscvlr to hlr
				glBegin(GL_POLYGON);
				 glColor3f(1,0.0,0.0);
				 glVertex2f(335+30-100,220);
				 glVertex2f(340+30-100,220);
				 glVertex2f(340+30-100,270);
				 glVertex2f(335+30-100,270);
				glEnd();
				//link mscvlr2 to hlr
				glBegin(GL_POLYGON);
				 glColor3f(1,0.0,0.0);
				 glVertex2f(335+20,230);
				 glVertex2f(340+20,230);
				 glVertex2f(340+20,270);
				 glVertex2f(335+20,270);
				glEnd();
				glBegin(GL_POLYGON);
				 glColor3f(1,0.0,0.0);
				 glVertex2f(355,235);
				...
				glBegin(GL_POLYGON);
				 glColor3f(1,1.0,0.0);
				 glVertex2f(290+100,280);
				 glVertex2f(292+100,278);
				 glVertex2f(298+100,278);
				 glVertex2f(300+100,280);
				 glVertex2f(300+100,300);
				 glVertex2f(298+100,297);
				 glVertex2f(292+100,297);
				 glVertex2f(290+100,300);
				glEnd();	
				glBegin(GL_LINE_LOOP); 
				 glColor3f(1.0,1.0,0.0);
				 glVertex2f(290+100,300);
				 glVertex2f(292+100,303);
				 glVertex2f(298+100,303);
				 glVertex2f(300+100,300);
				 glVertex2f(298+100,297);
				 glVertex2f(292+100,297);
				 glVertex2f(290+100,300);
				...
				//draw auc
 				glBegin(GL_LINE_LOOP); 
				 glColor3f(1.0,0.0,0.0);
				 glVertex2f(430-100,340-130);
				glVertex2f(440-100,350-130);
				glVertex2f(450-100,350-130);
				glVertex2f(460-100,340-130);
				glVertex2f(450-100,330-130);
				glVertex2f(440-100,330-130);
				glVertex2f(430-100,340-130);
			   glEnd(); 
			   glBegin(GL_LINE_LOOP); 
				glColor3f(1.0,0.0,0.0);
				...
				glVertex2f(450-100,330-130);
				glVertex2f(460-100,340-130);
				glVertex2f(460-100,323-130);
				glVertex2f(450-100,313-130);
				glVertex2f(440-100,313-130);
				glVertex2f(430-100,323-130);
				glVertex2f(430-100,340-130);
			   glEnd(); 
			   glBegin(GL_LINES);
				glColor3f(1.0,0.0,0.0);
				glVertex2f(440-100,330-130);
				glVertex2f(440-100,315-130);
			   glEnd();
			   glBegin(GL_LINES);
			    glColor3f(1.0,0.0,0.0);
				glVertex2f(450-100,330-130);
				glVertex2f(450-100,315-130);
		       glEnd();
			   glBegin(GL_LINES);
				glColor3f(0.0,1.0,0.0);
				glVertex2f(435-100,345-130);
				glVertex2f(455-100,335-130);
			   glEnd();
			   glBegin(GL_LINES);
				glColor3f(0.0,1.0,0.0);
				glVertex2f(455-100,345-130);
				glVertex2f(435-100,335-130);
			   glEnd();
			   //end auc
				glColor3f(1.0f,1.0f,1.0f);
				...
				glColor3f(1.0f,1.0f,1.0f);
 				...
 				drawstring(265.0,310.0,1.0,"MSC/VLR");
 				glColor3f(1.0f,1.0f,1.0f);	
 				drawstring(265.0,180.0,1.0,"HLR");
 				glColor3f(1.0f,1.0f,1.0f);	
 				drawstring(255+80.0,170.0,1.0,"AUC");
 				glColor3f(1.0f,1.0f,1.0f);
 				drawstring(365.0,310.0,1.0,"MSC/VLR 2");temp=5;
 				//draw poygon on tower
				glBegin(GL_POLYGON);
				 glColor3f(1,0.0,0.0);
...
{	glClear(GL_COLOR_BUFFER_BIT);
	...
	glColor3f(0.0,1.0,1.0);
	drawstring(70.0,230.0,1.0,"                     Mr. Muneshwara, M.S.                            Mrs. Ambika. G.N ");
	setFont(GLUT_BITMAP_HELVETICA_12);
	glColor3f(0.0,1.0,1.0);
	drawstring(70.0,215.0,1.0,"                            B.E, (M.Tech), Dept. of CS&E                                     M.Tech, Dept. of CS&E");
	glColor3f(0.0,1.0,1.0);
	drawstring(70.0,200.0,1.0,"                             BMSIT                                                                    BMSIT");
	draw_key_int();
	glFlush();
}

void draw_key_int1(void)	// ext for keyboard interaction
{	glColor3f(0.0,0.0,0.0);
glBegin(GL_POLYGON);
glVertex2f(0,0);
glVertex2f(0,135);
...
glColor3f(1.0f,1.0f,1.0f);
setFont(GLUT_BITMAP_HELVETICA_18);
drawstring(360.0,130.0,1.0,"Next Page");
glColor3f(1.0f,1.0f,1.0f);
drawstring(360.0,110.0,1.0,"Enter a number :  ");
glFlush();
}
